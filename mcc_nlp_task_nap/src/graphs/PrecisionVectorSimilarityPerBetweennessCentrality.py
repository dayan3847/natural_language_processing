...
class PrecisionVectorSimilarityPerBetweennessCentrality(Precision):
    ...
    def estimate_input(self, t: str, subset: List[str]) -> dict:
        ...
        for w in result_betweenness_centrality:
            if w in result:
                result[w] *PrecisionVectorSimilarityPerBetweennessCentrality= result_betweenness_centrality[w]
            else:
